...
export const CONSULTING_SERVICES: ConsultingService[] = [
  ...
  },
  {
    ...
    solutions: [
      ...
      'Pulsante �SAggiungi al prossimo appuntamento”'
    ],
    economicBenefits: {
  ...
  },
  {
    ...
    problem: 'Telefonate continue �SÈ pronta?” che disturbano il flusso in officina.',
    solutions: [
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Coda Virtuale', desc: 'Clienti liberi di fare un giro, SMS al tavolo pronto', icon: '�S�' }
    },
  ...
  },
  {
    ...
    stats: [
      ...
      { icon: '�S�', label: "Status", value: "Web", color: "from-brand-orange/20 to-brand-orange/10", text: "text-brand-orange" }
    ],
    beforeAfter: {
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Digital Gift', desc: 'PDF automatico, incasso immediato', icon: '�S�' }
    },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Certezza', desc: 'Ritiro garantito e veloce', icon: '�S�' }
    },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Instant Wow', desc: 'Anteprima visiva, prezzo certo, ordine ok', icon: '�S�' }
    },
  ...
  },
  {
    ...
    stats: [
      ...
      { icon: '�S', label: "Trust", value: "+60%", color: "from-blue-500/20 to-blue-600/10", text: "text-blue-400" },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Comfort Zone', desc: 'Prendi il numero via QR, aspetti dove vuoi', icon: '�S�' }
    },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Smartphone App', desc: 'Sempre pronta, push di compleanno, premi', icon: '�S�' }
    },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Smart Booking', desc: 'Sincronizzazione reale, risposte automatiche', icon: '�S�' }
    },
  ...
  },
  {
    ...
    stats: [
      ...
      { icon: '�S�', label: "UX", value: "Premium", color: "from-brand-orange/20 to-brand-orange/10", text: "text-brand-orange" }
    ],
    beforeAfter: {
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Smart Track', desc: '"In montaggio", "Controllo Qualità", "Pronto!"', icon: '�S�' }
    },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Filtro Digitale', desc: 'Arrivano in casa solo i clienti già innamorati del tour 3D', icon: '�S�' }
    },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Sync Perfetto', desc: 'Slot prenotabili online e notifiche WhatsApp a tutti', icon: '�S�' }
    },
  ...
  },
  {
    ...
    stats: [
      ...
      { icon: '�S', label: "Burocr", value: "-90%", color: "from-green-500/20 to-green-600/10", text: "text-green-400" },
    ...
    beforeAfter: {
      ...
      after: { title: 'Azione Rapida', desc: 'Compilazione guidata e firma OTP su smartphone', icon: '�S�️' }
    },
  ...
  },
  {
    ...
    stats: [
      { icon: '�S�', label: "Appealing", value: "+70%", color: "from-purple-500/20 to-purple-400/10", text: "text-purple-400" },
    ...
    beforeAfter: {
      ...
      after: { title: 'Potenziale', desc: 'Render fotorealistico: come potrebbe diventare', icon: '�S�' }
    },
  ...
  },
  {
    ...
    stats: [
      ...
      { icon: '�S�', label: "Experience", value: "Premium", color: "from-brand-orange/20 to-brand-orange/10", text: "text-brand-orange" }
    ],
    beforeAfter: {
      before: { title: 'Timidezza', desc: 'Guardare la vetrina senza il coraggio di entrare a provare', icon: '😕' },
      after: { title: 'Interazione AR', desc: 'Provare l\'anello sul dito con la fotocamera del cell', icon: '�S�' }
    },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Certezze', desc: 'Prezzo aggiornato in tempo reale ad ogni modifica', icon: '�S�' }
    },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Trasparenza', desc: '"In lucidatura", "Controllo qualità", "Pronto!"', icon: '�S�' }
    },
  ...
  },
  {
    ...
    beforeAfter: {
      before: { title: 'Busta Bianca', desc: 'Un pezzo di carta con una cifra scritta a penna', icon: '�S�️' },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Splendore', desc: 'Ogni gioiello torna come nuovo grazie ai tuoi tutorial', icon: '�S�' }
    },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Gestione Smart', desc: 'Grafica wow, tasto "Conferma" e link "Come arrivare"', icon: '�S�' }
    },
  ...
  },
  {
    ...
    stats: [
      ...
      { icon: '�S�', label: "UX", value: "Wow", color: "from-brand-orange/20 to-brand-orange/10", text: "text-brand-orange" }
    ],
    beforeAfter: {
  ...
  // --- HOTEL & B&B (10 Servizi) ---
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Arrivo Smart', desc: 'Chiave già pronta e ospite che va dritto in camera in 2 minuti', icon: '�S�' }
    },
  ...
  },
  {
    ...
    stats: [
      { icon: '�S�', label: "Trust", value: "High", color: "from-blue-500/20 to-blue-600/10", text: "text-blue-400" },
  ...
  },
  {
    ...
    stats: [
      { icon: '�S�', label: "Visual", value: "Wow", color: "from-blue-500/20 to-blue-600/10", text: "text-blue-400" },
  ...
  },
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Chat Onnipresente', desc: 'Tutto sul telefono del cliente, conferma rapida e link utili sempre a portata', icon: '�S�' }
    },
  ...
  // --- JEWELRY (10 Servizi) ---
  {
    ...
    beforeAfter: {
      ...
      after: { title: 'Specchio Digitale', desc: 'Indossare virtualmente il gioiello in tempo reale con precisione millimetrica', icon: '�S�' }
    },
  ...
  },
  {
    ...
    stats: [
      ...
      { icon: '�S', label: "Asset", value: "Digital", color: "from-brand-orange/20 to-brand-orange/10", text: "text-brand-orange" }
    ],
    beforeAfter: {
  ...
  // --- MEDICAL ---
  {
    ...
    problem: 'Segreteria intasata dalle chiamate e impossibilit� di prenotare fuori orario.',
    solutions: ['Agenda digitale condivisa', 'Prenotazione da smartphone', 'Promemoria automatici'],
    economicBenefits: { title: 'Efficienza', benefits: ['Meno no-show', 'Segreteria pi� libera'], savings: '-30% tempo telefono' }
  },
  // --- FITNESS ---
  {
    id: 'FIT1',
  ...
  // --- PETS ---
  {
    ...
    economicBenefits: { title: 'Ricorrenza', benefits: ['Aumento visite', 'Clienti pi� fedeli'], savings: '+25% fatturato' }
  },
  // --- BARBER ---
  {
    id: 'BAR1',
    ...
    solutions: ['Ticket digitale', 'Notifica "� il tuo turno"', 'Display in vetrina'],
  ...
  // --- HOME ---
  {
    ...
    economicBenefits: { title: 'Conversione', benefits: ['Meno resi', 'Decisioni pi� veloci'], savings: '+30% conversion rate' }
  },
  // --- TRAVEL ---
  {
    id: 'TRA1',
    ...
    problem: 'Clienti ansiosi con fogli volanti e difficolt� a contattare l\'agenzia in viaggio.',
  ...
  // --- EDUCATION ---
  {
    ...
    economicBenefits: { title: 'Scalabilit�', benefits: ['Recupero lezioni facile', 'Vendita corsi online'], savings: '+MRR corsi online' }
  },
  // --- TECH ---
  {
    id: 'TCH1',
    ...
    problem: 'Cliente ansioso che chiama ogni giorno per sapere "se � pronto".',
  ...
  // --- CONSTRUCTION ---
  {
    ...
    economicBenefits: { title: 'Qualit�', benefits: ['Cliente tranquillo', 'Meno visite in cantiere'], savings: '+10% velocit� lavori' }
  },
  // --- GARDENING ---
  {
    id: 'GRD1',
    name: 'Progettazione 3D Giardini',
    shortDescription: 'Vedi il giardino (e come crescer�) prima di piantare',
    icon: '<?',
    category: 'Digitalizzazione',
  ...
  // --- CLEANING ---
  {
    ...
    solutions: ['Calendario real-time', 'Pagamento online', 'Checklist qualit�'],
  ...
  // --- GROCERY ---
  {
    ...
    problem: 'Complessit� di un vero e-commerce per un alimentari di quartiere.',
    solutions: ['Bot ricezione ordini', 'Pagamento alla consegna', 'Recall prodotti freschi'],
    economicBenefits: { title: 'Semplicit�', benefits: ['Nessun sito complesso', 'Clienti anziani inclusi'], savings: '+20% ordini domicilio' }
  },
  // --- LAUNDRY ---
  {
    id: 'LND1',
    ...
    economicBenefits: { title: 'Volumi', benefits: ['Servizio premium', 'Pi� capi per cliente'], savings: '+30% fatturato' }
  },
  // --- COWORKING ---
  {
    id: 'CWK1',
    ...
    solutions: ['Visualizzazione disponibilit�', 'Pagamento orario', 'Codice accesso'],
  ...
  // --- CAR SALES ---
  {
    ...
    economicBenefits: { title: 'Qualifica Lead', benefits: ['Visite solo interessate', 'Tasso chiusura pi� alto'], savings: 'Tempo venditori ottimizzato' }
  },
  // --- INSURANCE ---
  {
    id: 'INS1',
